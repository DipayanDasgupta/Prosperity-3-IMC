...
# Product class (updated to fix CROISSANT typo)
class Product:
    ...
    DJEMBES = "DJEMBES"
    CROISSANTS = "CROISSANTS"  # Fixed from CROISSANT
    JAMS = "JAMS"
...
# PARAMS (extended to include JAMS and DJEMBES)
PARAMS = {
...
class Trader:
    def __init__(self, params=None):
        ...
        self.use_rolling_mean = False  # Use fixed mean for consistency with second code
    ...
    def run(self, state: TradingState) -> Tuple[Dict[str, List[Order]], int, str]:
        ...
        if Product.RAINFOREST_RESIN in state.order_depths:
            result[Product.RAINFOREST_RESIN].extend(self.trade_resin(state))
