...
# PARAMS (unchanged, but adding VOLCANIC_ROCK parameters)
PARAMS = {
    ...
    Product.VOLCANIC_ROCK: {
        "window_size": 50,  # From your friend's code
        "zscore_threshold": 2  # From your friend's code
    }
}
...
class Trader:
    ...
    # Refactored VOLCANIC_ROCK strategy
    ...
    def run(self, state: TradingState) -> Tuple[Dict[str, List[Order]], int, str]:
        ...
        # VOLCANIC_ROCK (updated strategy)
