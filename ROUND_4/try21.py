...
# Strategy base class (for PicnicBasketStrategy)
class Strategy:
...
# Improved PicnicBasketStrategy for CROISSANTS
...
# Trader class (with updated croissants_strategy)
class Trader:
    def __init__(self, params=None):
        ...
        self.strikes = {symbol: k for symbol, k in zip(Product.VOUCHER_SYMBOLS,
